...
gulp.task('set-variables', function() {
    source = 'build';
    directory = env === 'development' ? "build" : env === 'production' ? "dist" : env === 'docs' ? "docs" : "build";
});
...
gulp.task('dev', function(){
  browserSync.init({
    ...
    files: [
      path.join(process.cwd(), directory + '/**/*.html')
    ]
  })
})
...
gulp.task('watch', function() {
    gulp.watch(path.join(process.cwd(), source + "/sass/") + "**/*.scss", ['sass-task']);
});
...
gulp.task('default', ['env-dev', 'set-variables'], function(){
  runSequence('sass-task', ['webpack', 'dev'], 'watch')
});

gulp.task('build', ['env-prod', 'set-variables'], function(){
  runSequence('sass-task', ['webpack', 'dev'], 'watch')
});

gulp.task('docs', ['env-docs', 'set-variables'], function(){
  runSequence('sass-task', ['webpack', 'dev'], 'watch')
});
