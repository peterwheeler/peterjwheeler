      ...
      <div className="about-container">
		<div className="about-image">
      	...
      	<div className="about-text">
			<h1>About</h1>
		<div className="lW" style={{"width" : "230px"}}></div>
		<div className="rW" style={{"width" : "0px"}}></div>
		<div className="lW" style={{"width" : "216px"}}></div>
		<div className="rW" style={{"width" : "0px"}}></div>
		<div className="lW" style={{"width" : "203px"}}></div>
		<div className="rW" style={{"width" : "0px"}}></div>
		<div className="lW" style={{"width" : "189px"}}></div>
		<div className="rW" style={{"width" : "14px"}}></div>
		<div className="lW" style={{"width" : "176px"}}></div>
		<div className="rW" style={{"width" : "29px"}}></div>
		<div className="lW" style={{"width" : "162px"}}></div>
		<div className="rW" style={{"width" : "44px"}}></div>
		<div className="lW" style={{"width" : "148px"}}></div>
		<div className="rW" style={{"width" : "58px"}}></div>
		<div className="lW" style={{"width" : "135px"}}></div>
		<div className="rW" style={{"width" : "73px"}}></div>
		<div className="lW" style={{"width" : "121px"}}></div>
		<div className="rW" style={{"width" : "88px"}}></div>
		<div className="lW" style={{"width" : "107px"}}></div>
		<div className="rW" style={{"width" : "102px"}}></div>
		<div className="lW" style={{"width" : "94px"}}></div>
		<div className="rW" style={{"width" : "117px"}}></div>
		<div className="lW" style={{"width" : "80px"}}></div>
		<div className="rW" style={{"width" : "132px"}}></div>
		<div className="lW" style={{"width" : "67px"}}></div>
		<div className="rW" style={{"width" : "147px"}}></div>
		<div className="lW" style={{"width" : "53px"}}></div>
		<div className="rW" style={{"width" : "161px"}}></div>
		<div className="lW" style={{"width" : "39px"}}></div>
		<div className="rW" style={{"width" : "176px"}}></div>
		<div className="lW" style={{"width" : "26px"}}></div>
		<div className="rW" style={{"width" : "191px"}}></div>
		<div className="lW" style={{"width" : "12px"}}></div>
		<div className="rW" style={{"width" : "205px"}}></div>
		<div className="lW" style={{"width" : "0px"}}></div>
		<div className="rW" style={{"width" : "220px"}}></div>
		<div className="lW" style={{"width" : "0px"}}></div>
		<div className="rW" style={{"width" : "235px"}}></div>
		<div className="lW" style={{"width" : "0px"}}></div>
		<div className="rW" style={{"width" : "0px"}}></div>
		<div className="lW" style={{"width" : "0px"}}></div>
		<div className="rW" style={{"width" : "0px"}}></div>
