				...
				<Grid fluid>
				    <Row className="show-grid">
				    	<Col xs={12} sm={6} md={6} lg={4}>
					    	<Link className="menu-item" to={{pathname: "/portfolio/juxtapose"}}>
					    ...
					    <Col xs={12} sm={6} md={6} lg={4}>
					    	<Link className="menu-item" to={{pathname: "/portfolio/portus"}}>
						    	<div className="image-item">
						...
						<Col xs={12} sm={6} md={6} lg={4}>
					      	<Link className="menu-item" to={{pathname: "/portfolio/lifelong"}}>
						      	<div className="image-item">
						...
						<Col xs={12} sm={6} md={6} lg={4}>
					      	<Link className="menu-item" to={{pathname: "/portfolio/wsi-institute"}}>
						      	<div className="image-item">
						...
						<Col xs={12} sm={6} md={6} lg={4}>
					      	<Link className="menu-item" to={{pathname: "/portfolio/archaeology"}}>
						      	<div className="image-item">
						...
						<Col xs={12} sm={6} md={6} lg={4}>
					      	<Link className="menu-item" to={{pathname: "/portfolio/acrg-wordpress"}}>
						      	<div className="image-item">
