				...
				<Grid fluid>
					<Row>
						<Col xs={10} xsOffset={1} md={4} mdOffset={1} className="project-headline">
							...
							<h3 className="link"><a href="https://tour.portusproject.org">View project</a></h3>
						</Col>
						<Col xs={10} xsOffset={1} md={6} mdOffset={0} className="project-image">
						...
						<Col xs={10} xsOffset={1} md={8} mdOffset={2} className="project-extra">
							<h2>Results</h2>
