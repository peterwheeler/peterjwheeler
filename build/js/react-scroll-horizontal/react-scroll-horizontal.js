// Forked from https://github.com/hew/react-scroll-horizontal/
...
export default class HorizontalScroll extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    // var curr = this.state.animValues + this.props.scrollValue
    // if(curr !== nextProps.scrollValue){
    //   console.log(curr, nextProps.scrollValue);
    //   this.setScrollValue(nextProps.scrollValue)
    // } else return
  }
  ...
  setScrollValue(val){
    // Bring in the existing animation values
    var animationValue = this.state.animValues
    var newAnimationValue = (animationValue + val)
